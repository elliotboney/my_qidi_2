#!/bin/bash
rsync -avz mks@qidi:~/printer_data/ printer_data/ --exclude backup --exclude gcodes/ --exclude logs/ --exclude "*.log" --exclude timelapse/ --exclude ".cache" --exclude ".temp" --exclude ".git" --exclude "comms/" --exclude "database/"
